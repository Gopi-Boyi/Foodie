...
public class FoodServiceImpl implements FoodService
{
    ...
    //To fetch the food item by id
    @Override
    public FoodResponse readFood(String id) {
       FoodEntity existingFood =  foodRepository.findById(id).orElseThrow(() -> new RuntimeException("Food not found id:"+ id));
    ...
    //TO delete the file in Database
    @Override

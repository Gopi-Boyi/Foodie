...
const Menubar = () => {
 const [active, setActive] = useState("home")
  ...
  <div className="container">
    <Link to="/"><img src={assets.logo10} alt="" className='mx-4' height={58} width={58} /></Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className='d-flex align-item-center gap-4'>
        ...
        <div className='postion-relative'>
          ...
          <span className='position-flex top-0 start-100 translate-middle badge rounded-pill bg-warning'>
            {uniqueItemsInCart}</span>
        </div>
        </Link>
